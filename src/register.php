...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO users_register  (full_name, email, password, phone) VALUES (?, ?, ?, ?)";
        ...
        <div class="min-h-screen flex flex-col items-center justify-center">
            <div
                ...
                <div class="md:max-w-md w-full px-4 py-4">
                    ...
                    <form id="register-form" method="POST">
                        <div class="mb-12">
                            ...
                            <p class="text-sm mt-4 text-gray-800">Already have an account? <a href="login_user.php"
                                    class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Sign in
                                    here</a></p>
                        </div>
                        ...
                        <div class="mt-8">
                            <label class="text-gray-800 text-xs block mb-2">Phone</label>
                            <div class="relative flex items-center">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
                            <div class="flex items-center">
                                ...
                                <label for="agree" class="ml-3 block text-sm text-gray-800">
                        ...
                        <div class="space-x-6 flex justify-center">
                            ...
                            <button type="button" class="border-none outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 inline" fill="#000"
                            ...
                            <button type="button" class="border-none outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 inline" fill="#007bff"
                ...
                <div class="w-full h-full flex items-center bg-[#000842] rounded-xl p-8">
                    <img src="https://readymadeui.com/signin-image.webp" class="w-full aspect-[12/12] object-contain"
                        alt="register-image" />
                </div>
            </div>
        </div>
