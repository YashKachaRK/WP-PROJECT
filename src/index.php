...
<head>
  ...
  <style>
    /* Add to your existing styles.css or add in a <style> tag */
    body {
      margin: 0;
      padding: 0;
    }
    ...
    .slide {
      ...
      height: 100%;
      display: none;
      /* Make sure the slides are hidden by default */
    }
      ...
      <div class="slide current">
        <div class="content">
          ...
          <p>
            ...
            quidem, architecto eos adipisci maxime aperiam!
          </p>
        </div>
      </div>
      <div class="slide">
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="max-w-2xl mx-auto text-center lg:mb-14">
        <div class="text-center py-12 bg-gray-100">
          <h2 class="text-2xl md:text-4xl font-extrabold text-black relative inline-block">
            Featured Products
            <span class="absolute left-0 bottom-0 w-full h-1 bg-blue-500 rounded-lg"></span>
          </h2>
        </div>
        <p class="mt-1 text-gray-600">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab, odio
          rem corrupti dicta ullam ratione nulla ipsum reprehenderit
          similique. Quibusdam.
        </p>
      </div>
      <!-- End Title -->
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Card -->
        <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition" href="#">
          <div class="aspect-w-16 aspect-h-10">
            <img class="w-full object-cover rounded-xl" src="images/Lehenga.png" alt="Blog Image" />
          </div>
          <h3 class="mt-5 text-xl text-gray-900">
            Lehenga
            <p class="text-gray-600 mt-1">
              Elegant bridal lehenga for special occasions.
            </p>
          </h3>
        ...
        <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition" href="#">
          <div class="aspect-w-16 aspect-h-10">
            <img class="w-full object-cover rounded-xl" src="images/Indo-Western Suit.png" alt="Blog Image" />
          </div>
          <h3 class="mt-5 text-xl text-gray-900">
            Indo-Western Suit
            <p class="text-gray-600 mt-1">
              A blend of traditional & modern fashion.
            </p>
          </h3>
          <p class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold text-gray-800">
            Learn more
        ...
        <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition" href="#">
          <div class="aspect-w-16 aspect-h-10">
            <img class="w-full object-cover rounded-xl" src="images/Gown.png" alt="Blog Image" />
          </div>
          <h3 class="mt-5 text-xl text-gray-900">
            Gown
            <p class="text-gray-600 mt-1">
              Luxury gowns for evening parties & receptions.
            </p>
          </h3>
          <p class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold text-gray-800">
            Learn more
        ...
        <div class="lg:col-span-5 lg:col-start-1">
          ...
          <div class="mb-8">
            <h2 class="mb-2 text-3xl text-gray-800 font-bold lg:text-4xl">
              Hassle-Free Wedding Attire Rentals
            </h2>
            <p class="text-gray-600">
              Rent stunning wedding outfits with ease. Our seamless process
              ensures you get premium-quality attire for your special day,
              delivered on time.
            </p>
          </div>
          <!-- End Title -->
          ...
          <blockquote class="relative">
            ...
            <div class="relative z-10">
              <p class="text-xl italic text-gray-800">
                "The entire rental process was smooth, and the lehenga was
                beyond stunning! Highly recommend for any wedding occasion."
              </p>
            </div>
            ...
            <footer class="mt-6">
              <div class="flex items-center gap-x-4">
                <div class="shrink-0">
                  <img class="size-8 rounded-full" src="images/user1.jpg" alt="Customer" />
                </div>
                <div class="grow">
                  <div class="font-semibold text-gray-800">Pooja Sharma</div>
            ...
            <ul class="grid grid-cols-2 divide-y divide-y-2 divide-x divide-x-2 divide-gray-200 overflow-hidden">
              <li class="flex flex-col -m-0.5 p-4 sm:p-8">
                ...
                <p class="text-sm sm:text-base text-gray-600">
                  satisfied customers who rented wedding outfits
                </p>
              </li>
              ...
              <li class="flex flex-col -m-0.5 p-4 sm:p-8">
                ...
                <p class="text-sm sm:text-base text-gray-600">
                  of rentals delivered on time for events
                </p>
              </li>
              ...
              <li class="flex flex-col -m-0.5 p-4 sm:p-8">
                ...
                <p class="text-sm sm:text-base text-gray-600">
                  unique designs available for rent
                </p>
              </li>
            </ul>
            <!-- End List -->
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 md:gap-20 md:grid-cols-3 lg:grid-cols-5 lg:gap-8">
        ...
        <div class="text-center">
          <svg class="w-auto h-8 mx-auto text-gray-800" width="227" height="88" viewBox="0 0 227 88" fill="none"
          ...
          <div class="shrink-0 flex justify-center gap-x-1 mt-3">
            <svg class="size-4 text-blue-500" width="51" height="51" viewBox="0 0 51 51" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <!-- Icon Block -->
        <div class="text-center">
          <svg class="w-auto h-8 mx-auto text-gray-800" width="100" height="33" viewBox="0 0 100 33" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <!-- Icon Block -->
        <div class="text-center">
          <svg class="w-auto h-8 mx-auto text-gray-800" width="106" height="36" viewBox="0 0 106 36" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <!-- Icon Block -->
        <div class="text-center">
          <svg class="w-auto h-8 mx-auto text-gray-800" width="140" height="47" viewBox="0 0 140 47" fill="none"
            xmlns="http://www.w3.org/2000/svg">
