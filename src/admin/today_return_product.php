...
$sql = "SELECT * FROM orders WHERE status = 'Rented' AND return_date = '$today' ORDER BY order_date DESC";
...
if (isset($_POST['search']) && !empty($_POST['search'])) {
    ...
    $sql = "SELECT * FROM orders 
            ...
            ORDER BY FIELD(status, 'Rented') DESC, order_date DESC";
...
<table class="w-full border-collapse rounded-lg overflow-hidden shadow-md">
    ...
    <tbody class="divide-y divide-gray-300">
        ...
        <tr class="bg-white hover:bg-gray-100">
            ...
            <td class="px-6 py-4">
                <a href="today_return.php?id=<?= $order['id']; ?>" class="text-blue-600 font-semibold hover:underline">View</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </tbody>
