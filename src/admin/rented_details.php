...
<main class="md:ml-64 p-8 transition-all duration-300">
    <nav class="text-sm text-gray-600">
        <ol class="flex space-x-2">
            ...
            <li>/</li>
            <li><a href="view_rented_order.php" class="hover:text-gray-900 font-semibold">View Rented</a></li>
        </ol>
    </nav>
    <h2 class="text-3xl font-extrabold text-gray-800 mb-6">Rented Order</h2>

    <!-- Centering the Order Details -->
    <div class="flex items-center justify-center ">
        <div class="bg-white shadow-xl rounded-lg p-8 w-full max-w-4xl border border-gray-200">
            <h2 class="text-3xl font-bold text-blue-700 mb-6 text-center">Rented Details</h2>
            ...
            <div class="mt-8 flex justify-between">
                <a href="view_rented_order.php" class="bg-gray-600 text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition">Back</a>
...
<div x-show="open" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center p-4">
    <div class="bg-white w-full max-w-lg p-6 rounded-2xl shadow-2xl transform transition-all">
        ...
        <!-- Modal Body (Form) -->
        <form action="rented_update.php" method="POST" class="mt-6 space-y-4">
