...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/jquery-validation@1.19.5/dist/jquery.validate.min.js"></script></head>
<body class="bg-light">
        <div class="font-[sans-serif] max-sm:px-4 bg-gray-100">
            ...
            <div class="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
                <div class="md:max-w-md w-full px-4 py-4">
                        ...
                        <div class="mb-12">
                            ...
                            <p class="text-sm mt-4 text-gray-800">Don't have an account <a href="register.php" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
                        </div>
